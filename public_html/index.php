<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        $pass = md5($pass2);
        $query = sprintf("SELECT * FROM usuarios WHERE usuario='%s' AND contrasena='%s'",$usu,$pass);
    ...
    <form action="index.php" method="post">
        <div class="area" >
            ...
            <div class="context">
                ...
                <br><br><br>
                <p><font size="4">Recordar Usuario</font size><input type="checkbox" name="mantener" value="1"></p>
            </div>
        </div >
    </form>
<?php
